...
#
# def groupPixelsIntoSpots2(imgdata: ImageData,
#                          iteration: int,
...
#
#             gene_mask = remove_small_objects(
#                 gene_mask, minimum_pixels, in_place=True,
#             )
#
...
#             if verbose:
#                 print(f"\n{gene_name}:\n"
#                       f"codeword: {gene_codeword.values}\n"
#                       f"on-bits : {on_bits}\n"
...
#
#             coord_list = [
#                 [*region.centroid,  # y and x coordinates
#                  region.equivalent_diameter]  # radius
#                 for region in
#                 regionprops(region_labels, cache=False)
#             ]
#             # print(f"\nGene {gene_name_str} with index {gene_idx}:\n",
#             #       np.array(coord_list))
#
#             # ____ save gene coordinates as a dataset in hdf5 file ____
#             gene_coords = h5file_coord.create_dataset(gene_name_str,
#                                                       data=np.array(coord_list))
#             gene_coords.attrs["index"] = gene_idx
#
#             for region in regionprops(region_labels, cache=False):
#
#                 # Z, Y, X coordinates
