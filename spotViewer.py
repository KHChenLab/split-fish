...
class LoadMsg(QMessageBox):
    ...
    also shows a funny picture of an image while waiting for file to load
    """
...
class SpotViewerMainWidget(QDialog):
    """
    the Main GUI widget
    """
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('SpotViewer')
        ...
        show_button_list = [
            ...
            ("spotviewer_images/leftarrow.png", self.handlePrevious, stylesheet_plain),
            ("spotviewer_images/rightarrow.png", self.handleNext, stylesheet_plain),
            ("spotviewer_images/eraser.png", self.erase, stylesheet_red)
        ]
    ...
    def handleFileButtons(self):
        ...
        for n, filetype in enumerate(self.input_filetypes):
            ...
            if sender is self.fileButtons[n]:
                ...
                pixmap = QPixmap(
                    "spotviewer_images/Fishes_loading_screen.png",
                )
